#!/usr/bin/python
# Code from: https://github.com/lemonCMS/hyperion_udp_yeelight/blob/master/yee.py
# See: https://hyperion-project.org/threads/xiaomi-rgb-bulb-simple-udp-server-solution.529/#post-7979
